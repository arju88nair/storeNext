...
<div class="new-collections" >
    <div class="container">
        <h3 class="animated wow zoomIn" data-wow-delay=".5s">Today's Deals</h3>

        <div class="Slickclass col-md-12">


            @foreach($deals as $item)

            <div class=" animated wow slideInUp" data-wow-delay=".5s" >
                <div class="bookCards col-xs-6 col-sm-2 col-md-12 col-lg-10 "><div class="item item_shadow"><div class="img_block_books"><a rel="external" data-ajax="false" href="/{{ $item['name'] }}/product_details/{{ $item['product_id'] }}"><img style="height: 160px;margin-left: -7%" src="{{ $item['image'] }}" width="100%" onerror="this.src='../../images/Default_Book_Thumbnail.png'"></a></div><div class="carousel_body_book"><div class="carousel_title_book"><h5 title="{{ $item['name'] }}">{{ $item['name'] }}</h5></div> <del class="text-error carousel_title_book_p_del" style="font-size: 82%; margin-left: 9%;color: darkgrey;">MRP - &#8377; {{ $item['price'] }}</del> <p class="carousel_title_book_p">&#8377; {{ $item['discount'] }}</p><div class="carousel_desc"></div></div></div></div>
            </div>
            @endforeach
...
<div class="new-collections">
    <div class="container">
        <h3 class="animated wow zoomIn" data-wow-delay=".5s">Trending Now</h3>
        <div class="new-collections-grids">
            ...
            <div  class="est animated wow zoomIn text-center" data-wow-delay=".5s"><button type="button" class="btn btn-default" onclick="loadMore()" id="load">Load More</button></div>
